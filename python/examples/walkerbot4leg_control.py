...
asset_root = "../../assets"
asset_file = "urdf/WalkBot4Leg/urdf/WalkBot4Leg.urdf"
...
while not gym.query_viewer_has_closed(viewer):
    ...
    if(loop_counter == 0):
        ...
        if(control_idx == 0):
            ...
            if(joint_idx<3):
                gym.set_dof_target_position(env0, joint_idx+9, 2.09)
            else:
                gym.set_dof_target_position(env0, joint_idx+3, 2.09)
        elif(control_idx == 1):
            gym.set_dof_target_position(env0, joint_idx, -2.09)
            if(joint_idx<3):
                gym.set_dof_target_position(env0, joint_idx+9, -2.09)
            ...
            if(joint_idx<3):
                gym.set_dof_target_position(env0, joint_idx+9, 0)
            else:
                gym.set_dof_target_position(env0, joint_idx+3, 0)
